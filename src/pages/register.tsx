    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gray-50">
      ...
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
          ...
          <div className="w-2/5 p-5 bg-green-500 text-white rounded-tl-2xl rounded-bl-2xl pb-36 px-12"> 
          <div className="font-bold text-left "> <span className="text-yellow-300">Health</span>Care</div>
        ...
        {!page &&
          <div className="w-3/5 ">
            ...
            <div className="flex flex-col items-center ">
             ...
             <option value="O-">O-</option>
              ...
              <button onClick={pageNext} className="border-2 border-green-500 bg-green-500 text-white px-4 py-2 inline-block font-semibold hover:bg-gray-50  hover:text-green-500">Next</button>
              </div>
            </div>
            </form>
          ...
          {page && <div className="w-3/5 ">
            ...
            <div className="flex flex-col items-center ">
              ...
              {/* <div className=" flex items-center bg-gray-200 w-64 p-2 mb-4"><BsCardImage className="text-gray-400 mr-2"/>
              ...
              <button  onClick={pageBack} className="border-2 border-green-500 bg-green-500 text-white px-4 py-2 inline-block font-semibold hover:bg-gray-50  hover:text-green-500">Back</button>
              <button onClick={handleSubmit} className="border-2 border-green-500 bg-green-500 text-white px-4 py-2 inline-block font-semibold hover:bg-gray-50  hover:text-green-500">Sign Up</button>
              </div>
            </div>
            </form> 
            </div>
